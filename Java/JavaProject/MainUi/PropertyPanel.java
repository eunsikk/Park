...
import javax.swing.*;
import JavaProject.EventListener.CharacterActionListener;
import java.awt.*;
...
public class PropertyPanel extends JPanel {
    ...
    public PropertyPanel(DefaultListModel<String> model) {
        ...
        for (String property : properties) {
            JButton button = new JButton(property, createScaledIcon(
                    "/Image/PropertyImages/" + property.toLowerCase() + ".png", 50, 50));
